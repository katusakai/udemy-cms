...
<?php include 'includes/admin_navigation.php' ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div id="columnchart_statistics" style="width: 'auto'; height: 500px;">
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
...
$select_unpublished_posts = mysqli_query($connection, $query);
$post_unpublished_count = mysqli_num_rows($select_unpublished_posts);
...
<!--Column chart data section start  -->
...
<?php
$element_text = ['All Posts', 'Active Posts', 'Unpublished Posts', 'Comments', 'Pending Comments', 'Users', 'Subsribers', 'Categories'];
$element_count = [$post_counts, $post_published_count, $post_unpublished_count, $comment_counts, $comment_unapproved_count, $user_counts, $subscriber_count, $categories_counts];
...
for ($i = 0; $i < count($element_text) ; $i++) {
 ...
 ?>
        ...
        var chart = new google.charts.Bar(document.getElementById('columnchart_statistics'));

        chart.draw(data, google.charts.Bar.convertOptions(options));
      }
    </script>

    <!--Column chart data section end  -->
